...
grasp_handles.user_modules.bayes.input_name = uicontrol(figure_handle,'units','normalized','Position',[0.37 0.93 0.4 0.05],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String',num2str(status_flags.user_modules.bayes.input_name),'HorizontalAlignment','right','Tag','input_name','Visible','on','callback','bayes_callbacks(''input_name'');');
...
grasp_handles.user_modules.bayes.input_index = uicontrol(figure_handle,'units','normalized','Position',[0.37 0.85 0.16 0.05],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String',num2str(status_flags.user_modules.bayes.input_index),'HorizontalAlignment','right','Tag','input_index','Visible','on','callback','bayes_callbacks(''input_index'');');
...
grasp_handles.user_modules.bayes.spot_x = uicontrol(figure_handle,'units','normalized','Position',[0.32 0.65 0.16 0.05],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String',num2str(status_flags.user_modules.bayes.spot_x),'HorizontalAlignment','right','Tag','spot_x','Visible','on','callback','bayes_callbacks(''spot_x'');');
...
grasp_handles.user_modules.bayes.eta0 = uicontrol(figure_handle,'units','normalized','Position',[0.32 0.55 0.16 0.05],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String',num2str(status_flags.user_modules.bayes.eta0),'HorizontalAlignment','right','Tag','eta0','Visible','on','callback','bayes_callbacks(''eta0'');');
...
grasp_handles.user_modules.bayes.sanoffset = uicontrol(figure_handle,'units','normalized','Position',[0.32 0.45 0.16 0.05],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String',num2str(status_flags.user_modules.bayes.sanoffset),'HorizontalAlignment','right','Tag','sanoffset','Visible','on','callback','bayes_callbacks(''sanoffset'');');
...
grasp_handles.user_modules.bayes.phioffset = uicontrol(figure_handle,'units','normalized','Position',[0.32 0.35 0.16 0.05],'FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','edit','String',num2str(status_flags.user_modules.bayes.phioffset),'HorizontalAlignment','right','Tag','phioffset','Visible','on','callback','bayes_callbacks(''phioffset'');');
...
grasp_handles.user_modules.bayes.rock_type = uicontrol('units','normalized','Position',[0.35,0.25,0.22,0.1],'HorizontalAlignment','center','FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','Popup','Tag','rock_type',...
...
grasp_handles.user_modules.bayes.boxing_type = uicontrol('units','normalized','Position',[0.35,0.2,0.35,0.1],'HorizontalAlignment','center','FontName',grasp_env.font,'FontSize',grasp_env.fontsize,'Style','Popup','Tag','boxing_type',...
