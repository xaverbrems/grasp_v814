...
matlab -r "cd H:\Werkstudent\Grasp_Modifikation\GRASP_Bayes_Holmes\New_Grasp_v8.07_code; grasp_startup_bayes_new; cd H:\Werkstudent\Grasp_Modifikation\Grasp_v814\grasp_barebones_bayes_compiled\grasp_windows_compiled64\;tic;mcc -m -v grasp; toc"
