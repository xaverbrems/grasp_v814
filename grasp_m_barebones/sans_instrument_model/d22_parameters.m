function resolution_matrix = d22_parameters(tof_wavelength_cutoff)
...
chopper_radius = 0.325;  %radius at which the centre of the neutron beam cuts.
chopper_spacing12 = 0.025; %m
chopper_spacing23 = 0.0; %m
chopper_spacing34 = 0.0; %m

chopper_opening_angle = 9.29*16; %degrees

instrument_guide_size = [40e-3, 55e-3];
last_chopper_sample_length = 16.820; %(m)
max_col = 12.8; %(m)
